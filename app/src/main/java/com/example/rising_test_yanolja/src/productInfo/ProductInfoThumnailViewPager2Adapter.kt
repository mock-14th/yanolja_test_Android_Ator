...
class ProductInfoThumnailViewPager2Adapter(private val adImgList : ArrayList<String>) : RecyclerView.Adapter<ProductInfoThumnailViewPager2Adapter.ViewHolder>() {
